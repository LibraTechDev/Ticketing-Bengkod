...
class EventController extends Controller
{
    ...
    public function create()
    {
        ...
        $locations = Lokasi::select('id', 'nama_lokasi')->get();
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect()->back()->withErrors(['error' => 'Terjadi kesalahan saat menambahkan event: ' . $e->getMessage()]);
        }
    ...
    public function destroy(string $id)
    {
        try {
            ...
            return redirect()->back()->withErrors(['error' => 'Event tidak ditemukan.']);
        }
